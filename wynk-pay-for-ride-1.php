...
if(!empty($emailing))
{
  ...
  $emailing  = "WYNK77875279";
   $captain_id = "WYNK74832498";
     $code = "WYNK-RIDE-125209235"; 
    $ref = "WYNK-RIDE-125209235"; 
	 	$means = "wallet";*/
...
//Wallet Number of patron
  ...
  $remita_wallet = $myName->showName($conn, "SELECT `remita_wallet` FROM `application`");	
