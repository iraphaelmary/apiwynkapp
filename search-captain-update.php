...
$username = "WYNK87627590";
   ...
   $mode = "cash"; 
  $pickup = "3 Church St, Ajangbadi 101245, Lagos, Nigeria."; 
     $destination = "Isheri,Lagos, Nigeria"; 
...
{
    $url = "https://maps.googleapis.com/maps/api/distancematrix/json?origins=".$lat1.",".$long1."&destinations=".$lat2.",".$long2."&mode=driving&language=en-EN&departure_time=now&sensor=false&key=AIzaSyAqg-tRYd1cgnpjiOJ12e3AzuTxA80PaJk";
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch, CURLOPT_PROXYPORT, 3128);
