...
$wallet_number  = $json['wallet_number'];
 ...
 $username = "WYNK65748932";
 $emailing = "WYNK65748932";
$wallet_number  = "4991114689";
...
echo json_encode(array("statusCode"=>200,"wynkid"=>$registeredby, "message"=>"Information Retieved Successfully","accountName"=>$accountName ));  
	}
