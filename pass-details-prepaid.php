...
$value = "";
 ...
 $query =  "SELECT  `id`, `pass_name`, `pass_type`, `pass_duration`, `payment`, `percentage_wynk`, `percentage_welfare`, `created_date`, `registeredby`, `status` FROM `captain_pass_setup`  WHERE `status` = 1 AND `pass_type` = 1";	
